    ...
    <div>
      ...
      <main>
        ...
        <section className="h-screen bg-[url('https://img.freepik.com/free-photo/vivid-blurred-colorful-wallpaper-background_58702-3888.jpg?t=st=1729556265~exp=1729556865~hmac=774a8dab57b1505b0373b8ab6934fcef8f32be927710cd0776a8fe0722325045')] bg-cover bg-center flex items-center justify-center transition duration-500 ease-in-out">
          <div className="text-center text-gray-800 font-semibold p-8 bg-white bg-opacity-80 rounded-lg shadow-lg transition-transform transform hover:scale-105">
            ...
            <div className="flex flex-col space-y-4 sm:space-y-0 sm:flex-row sm:space-x-4">
              <Link href="#about" className="w-full sm:w-auto bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition duration-300 transform hover:scale-105 text-center">
                Learn More
              </Link>
              ...
              <Link href="https://github.com/Afsheen-imran" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto bg-indigo-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-indigo-700 transition duration-300 transform hover:scale-105 text-center">
                View My Repository
              </Link>
            </div>
          </div>
        ...
        {/* About Section */}
        <section id="about" className="py-16 sm:py-20 bg-gradient-to-r from-gray-100 to-gray-300 text-gray-800 text-center transition transform hover:scale-105">
          <div className="container mx-auto p-6 sm:p-10 rounded-lg shadow-lg transition duration-500 hover:shadow-xl bg-white">
            <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 sm:mb-8">About Me</h3>
            <p className="text-lg sm:text-xl md:text-2xl leading-7 max-w-5xl mx-auto mb-6 sm:mb-8 font-semibold transition-transform duration-300 hover:text-blue-600 hover:scale-105 transform-gpu">
            ...
            <Link href="#portfolio" className="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition duration-300 transform hover:scale-105">
              View My Work
            </Link>
          </div>
        </section>
        ...
        {/* Projects Section */}
        <section id="portfolio" className="py-12 sm:py-16 bg-gray-100 text-center">
          <div className="container mx-auto">
            <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 sm:mb-8 text-gray-800">My Projects</h3>
            <p className="text-lg sm:text-xl md:text-2xl mb-6 sm:mb-8 font-semibold text-gray-700">
